...
type ModalComponentType = ModalSubmitComponent['type'];
type _TypeToModalComponentMap = {
    [Component in ModalComponentType]: ModalSubmitComponent & {
        type: Component;
    };
};
type TypeToModalComponentMap = {
 ...
 */
declare class AutocompleteInteractionOptionResolver {
 ...
 * Based on {@linkplain https://github.com/discordjs/discord.js/blob/main/packages/discord.js/src/structures/CommandInteractionOptionResolver.js}
 */
declare class ChatInputInteractionOptionResolver {
    /**
     * The interaction options array
     */
    private readonly data;
 ...
 * Based on {@linkplain https://github.com/discordjs/discord.js/blob/main/packages/discord.js/src/structures/CommandInteractionOptionResolver.js}
 */
declare class ContextMenuInteractionOptionResolver {
    private readonly interaction;
    /**
     * The interaction resolved data
     */
 ...
 * Based on {@linkplain https://github.com/discordjs/discord.js/blob/main/packages/discord.js/src/structures/CommandInteractionOptionResolver.js}
 */
declare class ModalInteractionOptionResolver {
    /**
     * The interaction resolved data
     */
    private readonly resolved;
